...
#define	LED_UPDATE_NAME_KNIGHT_RIDER		L"1"
#define	LED_UPDATE_NAME_RAINBOW				L"2"
#define	LED_UPDATE_NAME_GAMING_RGB			L"3"
#define	LED_UPDATE_NAME_BATTERY_IS_CHARING	L"BatteryIsCharing"
#define	LED_UPDATE_NAME_CAR_ACCIDENT		L"CarAccident"
LAZY_MESSAGE_HEADER_STAR(eCDNM_S2C_LED_HW_TEST)
	unsigned char	ucColor[3];
	int				iSpeed;
	float			fLimunance;
	char			strUpdateName[20];
	bool			bOnlyChangeUpdateName;
...
LAZY_MESSAGE_HEADER_STAR(eCDNM_S2C_LID_MOTOR_STATUC_CHANGE_REQUEST)
	int		iCarID;
	bool	bOpen;
LAZY_MESSAGE_HEADER_END(eCDNM_S2C_LID_MOTOR_STATUC_CHANGE_REQUEST)


LAZY_RESULT_MESSAGE_HEADER_STAR(eCDNM_C2S_LID_MOTOR_STATUC_CHANGE_RESULT)
LAZY_RESULT_MESSAGE_HEADER_END(eCDNM_C2S_LID_MOTOR_STATUC_CHANGE_RESULT)
...
LAZY_MESSAGE_HEADER_STAR(eCDNM_S2C_TIME_SYNC)
	int32	i32Time;
LAZY_MESSAGE_HEADER_END(eCDNM_S2C_TIME_SYNC)
